...
var blBookcontrollers = angular.module('bookland');
...
blBookcontrollers.controller('ListController', ListController);
...
blBookcontrollers.controller('DetailController', DetailController);
